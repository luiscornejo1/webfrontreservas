...
@Component({
  selector: 'app-piso19-zona4',
  templateUrl: './piso19-zona4.component.html',
  styleUrls: ['./piso19-zona4.component.css']
})
export class Piso19Zona4Component implements OnInit {
  ...
  asientos: { codigo: string, nombre: string | null, estado: 'ocupado' | 'libre' | 'no disponible' }[] = [
    { codigo: 'UAT 2', nombre: null, estado: 'libre' },
    { codigo: 'UAT 1', nombre: null, estado: 'libre' },
    { codigo: 'UAT 4', nombre: null, estado: 'libre' }
  ];
  mostrarModal = false;
