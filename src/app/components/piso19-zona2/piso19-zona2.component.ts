...
@Component({
  selector: 'app-piso19-zona2',
  templateUrl: './piso19-zona2.component.html',
  styleUrls: ['./piso19-zona2.component.css']
})
export class Piso19Zona2Component implements OnInit {
  ...
  asientos: { codigo: string, nombre: string | null, estado: 'ocupado' | 'libre' | 'no disponible' }[] = [
    { codigo: 'UAT 8', nombre: null, estado: 'libre' },
    { codigo: 'UAT 9', nombre: null, estado: 'libre' },
    { codigo: 'UAT 10', nombre: null, estado: 'libre' }
  ];
  mostrarModal = false;
