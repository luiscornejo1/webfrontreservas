...
@Component({
  selector: 'app-piso19-zona3',
  templateUrl: './piso19-zona3.component.html',
  styleUrls: ['./piso19-zona3.component.css']
})
export class Piso19Zona3Component implements OnInit {
  ...
  asientos: { codigo: string, nombre: string | null, estado: 'ocupado' | 'libre' | 'no disponible' }[] = [
    { codigo: 'ARTS 1', nombre: null, estado: 'libre' },
    { codigo: 'UAT 3', nombre: null, estado: 'libre' },
    { codigo: 'UAT 5', nombre: null, estado: 'libre' },
    { codigo: 'UAT 6', nombre: null, estado: 'libre' },
    { codigo: 'UAT 7', nombre: null, estado: 'libre' }
  ];
  mostrarModal = false;
